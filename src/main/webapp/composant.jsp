...
<div class="container-fluid">
    <div class="row flex-nowrap">
        <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                ...
                <!-- SEARCH BAR	 -->
        <div class="col py-3">
        <form action="Composant" class="row" method="GET">
        <div class="col-sm-3"></div>
        <div class=" col-sm-7">  <input type="text" name="barsearch" id="form1" class="form-control" placeholder="Recherche" aria-label="Search"  /> </div>
        <div class="col-sm-2 "><button name="action" value="select" id="search-button" type="submit" class="btn btn-primary"> <i class="bi bi-search"></i>RECHERCHE</button></div>
                ...
                <!-- FILTRE -->
        <form action="Composant" class="row" method="GET" id="filtre" style=" display : none">
        <div class="col-sm-2">
    ...
    <thead>
        ...
        <th id ="hbox" style=" display : none"></th>
            ...
            %>
            <th>
                <button id="addRowButton" class="btn btn-link-black" onclick="toggleCForm()">
            ...
            <tr class="selectable-row"  data-row-index="<%= j %>">
             <td id="box"  style=" display :none "  ><input type="checkbox" name="selectedRow" value="<%= noms[0][j] %>" checked></td>
                ...
                <td>
                    ...
                    <button onclick="afficherPopupC(<%= j %>)" class="btn btn-secondary">Update</button>
                </td>
                <td>
                    <form class="" action="Composant" method="GET">
...
<!-- Ajout machine -->
   ...
   <div id="popupC" class="popup" >
        <div class="popup-content">
            <span onclick="masquerPopupC()" class="close" id="closeButton">&times;</span>
            <h2>Modifier Composant</h2>
            <form id="popupForm" class="row g-3" action="Composant" method="GET">
              	<div class="col-md-4">
    				<label  class="form-label">N° Serie Composant</label>
   					<input type="text" class="form-control" id="UNSerC" name="UN°SerC">
   					<input type="hidden" class="form-control" id="AUNSerC" name="AUN°SerC">
				</div>
  				<div class="col-md-4">
    				<label  class="form-label">References</label>
    				<input type="text" class="form-control" id="URefC" name="URefC">
 				</div>
  				<div class="col-md-4">
  				...
  				<div class="col-md-4">
    				...
    				<input type="date" class="form-control" id="UDateEC" name="UDateEC">
 	 			</div>
  				<div class="col-md-4">
    				<label  class="form-label">Etat</label>
    				<select id="UEtatC" name="UEtatC" class="form-select">
      					<option>Active</option>
      					<option selected>Stock</option>
      					<option>Reparation</option>
    				</select>
  				...
  				<div class="col-md-4">
    				...
    				<input type="text" class="form-control" id="UMacC" name="UMacC" >
  				</div>
 				<div class="col-12">
				...
				<form action="Transfert" class="row g-3" method = "GET">
  				...
  				<div class="col-md-4">
    				<label for="inputAddress" class="form-label">Provenance</label>
   	 				<select name="IExp" id="IExp" class="form-select">
        				  <%  if (agences != null) {
              					for (int j = 0; j < agences.length; j++) {
                  					String option = agences[j];
              						%>
