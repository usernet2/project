...
<!-- TABLEAU -->
    ...
    <thead>
        ...
        <th id ="hbox" style=" display : none"></th>
            ...
            %>
            <th>
                <button id="addRowButton" class="btn btn-link-black" onclick="toggleRForm()">
    ...
    <tbody>
        ...
        if (noms != null) {
            ...
            <tr class="selectable-row"  data-row-index="<%= j %>">
                ...
                %>                
                <td onclick="repa(<%= j %>)">
                <input type="hidden" id="date_<%= j %>" value="<%= noms[2][j] %>">
                <input type="hidden" id="info_<%= j %>" value="<%= noms[3][j] %>">
                <input type="hidden" id="inforef_<%= j %>" value="<%= noms[4][j] %>">
                <%= nom %>
                </td>
                <%
                }
                ...
                <td>
                    ...
                    <button onclick="afficherPopupR(<%= j %>)" class="btn btn-secondary">Update</button>
                </td>
                <td>
                    <form class="" action="Reparation" method="GET">
...
<!-- Ajout reparation -->
				...
				<div class="col-md-3">
 				...
 				<div class="col-12">
    				<button type="submit" name="action" value="insertion" class="btn btn-primary">Enregistrer</button>
   					<a onclick="clearInputs()" class="btn btn-primary">Annuler</a>
  				</div>
				</form>
		</div>
		<!-- Update reparation -->
   		<div id="popupR" class="popup" >
        <div class="popup-content">
            <span onclick="masquerPopupR()" class="close" id="closeButton">&times;</span>
            <h2>Modifier Composant</h2>
				<form action="Reparation" class="row g-3" method = "GET">
  				<div class="col-md-4">
    				<label for="inputEmail4" class="form-label">Date Arrivée</label>
    				<input type="hidden" id="Uid" name="Uid">
   					<input type="date" class="form-control" name="UDateAR" id="UDateAR" required>
				</div>
				<div class="col-md-4">
    				<label for="inputEmail4" class="form-label">Debut reparation</label>
   					<input type="date" class="form-control" name="UDebutR" id="UDebutR" required>
				</div>
  				<div class="col-md-4">
    				<label for="inputPassword4" class="form-label">N°Serie Materiel</label>
					<select name="UMateriel" id="UMateriel" class="form-select">
         			 <%
          				if (listemac != null) {
            			  for (int j = 0; j < listemac.length; j++) {
                		  String option = listemac[j];
 				...
 				<div class="col-md-4">
    				<label for="inputAddress" class="form-label">Responsable</label>
   	 				<input type="text" class="form-control" name="URespbl" id="URespbl" required >
  				</div>
  				<div class="col-md-4">
    				<label for="inputAddress" class="form-label">Observation</label>
  					<textarea class="form-control" id="UPblm" name="UPblm" rows="3" required></textarea>  				
  				</div>
  				<div class="col-md-4">
    				<label for="inputAddress" class="form-label">Solution</label>
  					<textarea class="form-control" id="Usolt" name="Usolt" rows="3"></textarea>  				
  				</div>
  				<div class="col-md-4">
   		 			<label for="inputAddress2" class="form-label">Fin reparation</label>
    				<input type="date" class="form-control" name="UFinR" id="UFinR" >
 	 			</div>
 				<div class="col-12">
    				<button type="submit" name="action" value="Update" class="btn btn-primary">Enregistrer</button>
   					<a onclick="masquerPopupR()" class="btn btn-primary">Annuler</a>
  				</div>
				</form>
        </div>
    </div>
     ...
     <div id="trans"  style=" display :none">
				<form action="Transfert" class="row g-3" method = "GET">
  				...
  				<div class="col-md-4">
    				...
    				<select name="IMateriel" id="IMateriel" class="form-select">
         			 <%  
          				if (listemac != null) {
            			  for (int j = 0; j < listemac.length; j++) {
                		  String option = listemac[j];
    ...
    <!-- Info Materiel -->
    <div id="reppc" class="popup" >
        <div class="popup-content">
            <span onclick="killinfo()" class="close" id="closeButton">&times;</span>
            <h2>Info</h2>
            <form id="popupForm" class="row g-3" action="Reparation" method="GET">
                <div class="col-auto">
    				<label  class="form-label">N° Serie Machine</label>
   					<input type="text" class="form-control" id="Ipc" name="infomac" disabled>
   					<input type="hidden" class="form-control" id="I_pc" name="infomach"   >
   					<input type ="hidden" id="datepc" name ="datei">
				</div>
  				<div class="col-auto">
    				<label  class="form-label">References</label>
    				<input type="text" class="form-control" id="Irefpc" name="inforef" disabled >
 				</div> 
  				<div class="col-md-4">
    				<label  class="form-label">CM</label>
    				<input type="text" class="form-control" id="SRepCm" name="SRepCm"  >
   	 				<input type="text" class="form-control" id="RepCm" name="RepCm"  >
   	 				<input type="hidden" class="form-control" id="HRepCm" name="HRepCm"  >
  				</div>
  				<div class="col-md-4">
   		 			<label class="form-label">CPU</label>
    				<input type="text" class="form-control" id="SRepCpu" name="SRepCpu" >
    				<input type="text" class="form-control" id="RepCpu" name="RepCpu" >
    				<input type="hidden" class="form-control" id="HRepCpu" name="HRepCpu" >
 	 			</div>
  				<div class="col-md-4">
    				<label  class="form-label">RAM</label>
    				<input type="text" class="form-control" id="SRepRam" name="SRepRam" >
    				<input type="text" class="form-control" id="RepRam" name="RepRam" >
    				<input type="hidden" class="form-control" id="HRepRam" name="HRepRam" >
  				</div>
  				<div class="col-md-4">
    				<label  class="form-label">Memoires</label>
    				<input type="text" class="form-control" id="SRepmem" name="SRepmem" >
    				<input type="text" class="form-control" id="Repmem" name="Repmem" >
    				<input type="hidden" class="form-control" id="HRepmem" name="HRepmem" >
  				</div>
  				<div class="col-md-4">
    				<label  class="form-label">Alimentation</label>
    				<input type="text" class="form-control" id="SRepalim" name="SRepalim" >
    				<input type="text" class="form-control" id="Repalim" name="Repalim" >
    				<input type="hidden" class="form-control" id="HRepalim" name="HRepalim" >
  				</div>
 				<div class="col-12">
    				<button type="submit" name="action" value="reparerpc" class="btn btn-outline-success">Enregistrer</button>
   					<a onclick="killinfo()" class="btn btn-outline-danger">Annuler</a>
  				</div>
            </form>
        </div>
    </div>
    <div id="repprinter" class="popup" >
        <div class="popup-content">
            <span onclick="killinfo()" class="close" id="closeButton">&times;</span>
            <h2>Info</h2>
            <form id="popupForm" class="row g-3" action="Reparation" method="GET">
                <div class="col-auto">
    				<label  class="form-label">N° Serie Machine</label>
   					<input type="text" class="form-control" id="Iprinter" name="infomac" disabled>
   					<input type="hidden" class="form-control" id="I_printer" name="infomach"   >
   					<input type ="hidden" id="dateprinter" name ="datei">
				</div>
  				<div class="col-auto">
    				<label  class="form-label">References</label>
    				<input type="text" class="form-control" id="Irefprinter" name="inforef" disabled >
 				</div> 
  				<div class="col-md-4">
    				<label  class="form-label">Toner</label>
    				<input type="text" class="form-control" id="SRepToner" name="SRepToner"  >
   	 				<input type="text" class="form-control" id="RepToner" name="RepToner"  >
   	 				<input type="hidden" class="form-control" id="HRepToner" name="HRepToner"  >
  				</div>
  				<div class="col-md-4">
   		 			<label class="form-label">Tambour</label>
    				<input type="text" class="form-control" id="SRepTambour" name="SRepTambour" >
    				<input type="text" class="form-control" id="RepTambour" name="RepTambour" >
    				<input type="hidden" class="form-control" id="HRepTambour" name="HRepTambour" >
 	 			</div>
  				<div class="col-md-4">
    				<label  class="form-label">Tête d'impression</label>
    				<input type="text" class="form-control" id="SRepTete" name="SRepTete" >
    				<input type="text" class="form-control" id="RepTete" name="RepTete" >
    				<input type="hidden" class="form-control" id="HRepTete" name="HRepTete" >
  				</div>
  				<div class="col-md-4">
    				<label  class="form-label"> Miroir pivotant</label>
    				<input type="text" class="form-control" id="SRepMiroir" name="SRepMiroir" >
    				<input type="text" class="form-control" id="RepMiroir" name="RepMiroir" >
    				<input type="hidden" class="form-control" id="HRepMiroir" name="HRepMiroir" >
  				</div>
  				<div class="col-md-4">
    				<label  class="form-label">Mémoire vive</label>
    				<input type="text" class="form-control" id="SRepmemV" name="SRepmemV" >
    				<input type="text" class="form-control" id="RepmemV" name="RepmemV" >
    				<input type="hidden" class="form-control" id="HRepmemV" name="HRepmemV" >
  				</div>
 				<div class="col-12">
    				<button type="submit" name="action" value="reparerprinter" class="btn btn-outline-success">Enregistrer</button>
   					<a onclick="killinfo()" class="btn btn-outline-danger">Annuler</a>
  				</div>
            </form>
        </div>
